/* ================= ÁRVORE DE HABILIDADES (dados) =================
   ...
   (ver game/tree.js), com três camadas:
   3 filhos -> 9 netos -> 27 folhas.
...
// Quatro especializações, dois conflitos. Os demais nós ficam livres.
export const MASTERIES = {
  '0-1-1-1': {name:'Canhão de Vidro',desc:'+18% de dano final, −10% de vida. Bloqueia Fortaleza Viva.',stat:'glass',conflict:'2-1-1-1'},
  '2-1-1-1': {name:'Fortaleza Viva',desc:'+2 HP; ataque 5% mais lento. Bloqueia Canhão de Vidro.',stat:'fortress',conflict:'0-1-1-1'},
  '3-1-1-1': {name:'Arsenal Vivo',desc:'+1 projétil; −8% dano por projétil. Bloqueia Precisão Absoluta.',stat:'volley',conflict:'4-1-1-1'},
  '4-1-1-1': {name:'Precisão Absoluta',desc:'+50% dano crítico; ataque 8% mais lento. Bloqueia Arsenal Vivo.',stat:'focus',conflict:'3-1-1-1'},
};
