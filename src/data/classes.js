...
CLASSES.push({name:'Atirador',ic:'🎯',color:'#62d8ff',hp:4,dmg:1.15,cd:.6,spd:138,abCd:10,
  ab:'Rajada de Precisão',desc:'Alcance longo, leque fechado e tiros velozes. A ativa dispara uma rajada perfurante.',pass:'Passiva: +180 alcance e +1 perfuração'});
