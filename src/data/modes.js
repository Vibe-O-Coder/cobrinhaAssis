...
export const MODES = [
  {id:'hardcore', n:'HARDCORE', ic:'🔥', d:'Vida máxima fixa. Sem loja ou árvore. Inimigos com +60% de vida e +25% de velocidade.', hpMul:1, dmgTaken:0, tailDmg:0, healMul:1, affixBonus:1, enrageAt:.65, enemySpd:1.25, enemyHp:1.6, poisonMul:1, soulMul:2, hardcore:true},
  {
    id: "normal",
    n: "NORMAL",
    ic: "🙂",
...
export function modeDef(id) {
  return MODE_BY_ID.get(id) || MODE_BY_ID.get("normal");
}

/** Atalho usado pelo código de jogo: `MODE()` é o modo da run em andamento. */
export let CURRENT = MODE_BY_ID.get("normal");
