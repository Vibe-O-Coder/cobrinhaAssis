...
function cast(e, head, newMinion) {
  ...
  switch (e.type) {
    ...
    case "boss5": {
      ...
      } else burst(e, "scythe", target, 2.2, stage ? 0.16 : 0.25);
      break;
    }
    case "boss6":
    ...
    case "boss_elite":
      ...
      if (move === 0) {
        ...
        for (let i = 0; i < (stage ? 7 : 4); i++) circle(e,
          ...
          110, 1 + i * 0.15, 1.7);
      } else burst(e, "scythe", target, 2.8, 0.16);
      break;
    case "boss_plague":
    ...
    case "boss_final": {
      const ar = arena();
      e.bossClock = stage === 2 ? 4.5 : 5.1;
      announce(e, ["CHUVA DE MUNDOS", "MANDÍBULAS DO COSMOS", "EXTINÇÃO"][move]);
      if (move === 0) {
